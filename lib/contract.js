...
export const NS = 'skill-mcp-panel';

/** Prefix the host claims on the Web server. Deliberately NOT under `/api`. */
export const HTTP_PREFIX = '/skill-mcp-panel/';

/** Read the whole state document. `GET`, no body. */
export const ROUTE_STATE = '/skill-mcp-panel/state';

/** Apply a batch of operations. `POST`, JSON body. */
export const ROUTE_APPLY = '/skill-mcp-panel/apply';
