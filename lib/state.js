/**
 * dsh-skill-mcp-panel — assembly of the `StatePayload` the management page reads.
 *
 ...
 *
 * @module dsh-skill-mcp-panel/state
 */
...
export function createStateBuilder(deps) {
  ...
  async function enumerateLayer(layer) {
    ...
    try {
      ...
      sink(`skill-mcp-panel: could not enumerate a registry layer: ${String(error)}`)
      return undefined
    }
  }
