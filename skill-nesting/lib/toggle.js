/**
 * dsh-skill-nesting — skill enable/disable: the suppression mechanism.
 *
 ...
 *
 * @module dsh-skill-nesting/toggle
 */
  ...
  candidates() {
    ...
    for (const name of [...this.disabled].sort()) {
      ...
      const description = typeof meta?.description === 'string' && meta.description !== ''
        ? `Disabled in skill-nesting: ${meta.description}`
        : 'Disabled in skill-nesting.'
      out.push({
        name,
        description,
        ...
        ...(typeof meta?.category === 'string'
          ? { metadata: { suppressedBy: 'skill-nesting', category: meta.category } }
          : {}),
      })
    }
    return out
